...
let findLongestWord = array =>{
  ...
  for (let i = 0; i < array.length; i++){
    if (longestWord === null || longestWord.length < array[i].length){
      longestWord = array[i]
    }
  }
  return longestWord
...
let averageNumbers = (array) =>{
  let average = 0;
  return sumNumbers(array)/array.length || null
}
...
let averageWordLength = (array) => {
  ...
  return averageLength/array.length || null
}
...
let avg = array => {
  ...
  return average/array.length || null;
}
